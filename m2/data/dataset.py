...
class PairedDataset(Dataset):
    def __init__(self, examples, fields):
        ...
        self.language_field = self.fields['language']
...
class ArtEmis(PairedDataset):
    def __init__(self, image_field, text_field, emotion_field, language_field, ann_root):
        ...
        super(ArtEmis, self).__init__(examples, {'image': image_field, 'text': text_field, 
                                                 'emotion': emotion_field, 'language': language_field})
