...
def preprocess(args, verbose=True, test_masterpieces=False):
    ...
    if args.too_high_repetition != -1:
        ...
        # high_coverage_df = high_coverage_df.drop(columns=[i for i in high_coverage_df.columns if 'anchor' in i])
    ...
    df['language_label'] = df.language.apply(language_to_int)
...
if __name__ == '__main__':
    ...
    vocab.save(osp.join(args.save_out_dir, 'huggingfacevocab.hug'))
