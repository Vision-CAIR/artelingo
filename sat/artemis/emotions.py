...
ARTEMIS_LANGUAGES = ['english', 'arabic', 'chinese']
LANGUAGE_TO_IDX = {e: i for i, e in enumerate(ARTEMIS_LANGUAGES)}
IDX_TO_LANGUAGE = {LANGUAGE_TO_IDX[e]: e for e in LANGUAGE_TO_IDX}
...
def language_to_int(language):
    """ Map a feeling string (e.g. 'awe') to a unique integer.
    :param language: (string)
    :return: int
    """
    return LANGUAGE_TO_IDX[language]